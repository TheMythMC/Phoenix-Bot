...
module.exports = class extends Command {
    ...
    async run(_args: string[], minecraftBot: MineflayerBot, _, playerName: string) {
		minecraftBot.bot.chat(`${playerName}, ${this.responses[Math.floor(Math.random() * this.responses.length)]}`);
    }
};